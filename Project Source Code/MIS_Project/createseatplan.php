...
table_created=true;
        ...
        //   alert(userid+" "+rows+" "+columns+" "+room_number);
           ...
           var form = $('<form action="' + url + '" method="post">' +
             ...
             if($('#assignY').is(':checked')){
             for(i=0;i<teachers.length;i++){
                var teacher='<input type="text" name="teachers[]" value="' + teachers[parseInt(i)]+ '" />';
                //alert(teachers[parseInt(i)]);
                form.append(teacher)
             }
             }
/*
             for(i=1;i<=rows;i++){
               for(j=1;j<=columns;j++){
                  var student_roll=$("#"+i+"_"+j).val();
                  var row_of_seat=i;
                  var column_of_seat=j;
                  alert(student_roll+" "+row_of_seat+" "+column_of_seat);
                  if(student_roll!=="Empty"){

                    var seat_student='<input type="text" name="students[][roll]" value="' + student_roll+ '" />'+
                                      '<input type="text" name="students[][row]" value="' + row_of_seat+ '" />'
                                      '<input type="text" name="students[][column]" value="' + column_of_seat+ '" />';
                    form.append(seat_student);
                    //alert('Not Empty');
                  }
                   //alert($("#"+i+"_"+j).val()+" "+i+" "+j);
               }
